...
public class EvaluationServiceImpl implements EvaluationService {
    ...
    @Override
    public Integer evaluateRoleConsistency(TrainingSession session, String aiResponse) {
        CustomerProfile profile = customerProfileService.getProfileById(session.getProfileId());

        try {

            String prompt = promptService.buildEvaluationPrompt("roleConsistency", profile, aiResponse);
